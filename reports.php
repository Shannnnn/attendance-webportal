                  ...
                  /**/if ($day_last_out != strtotime("00:00:00") && $day_last_out > $day_first_in && $check_day_day->row_num == 2){
                    ...
                    if ($day_current_hour > '01:00:00'){
                      ...
                      if ($day_current_hour >= '08:00:00'){
                        ...
                        //echo $row->empid." - ".$out_count2." 1<br>";
                      }
                    }
                  }
                  ...
                  if ($day_last_out != strtotime("00:00:00") && $day_first_in_in != strtotime("00:00:00") && $day_first_in_in > $day_last_out){
                      ...
                      if ($day_current_hour > '01:00:00'){
                        ...
                        if ($day_current_hour >= '08:00:00'){
                          $out_count2++;
                          $last_limit2 = $check_day_day->row_num;
                          //echo $row->empid." - ".$out_count2." 2<br>";
                        }
                      }
                      ...
                      if ($day_current_hour > '01:00:00'){
                        ...
                        if ($day_current_hour >= '08:00:00'){
                          $out_count2++;
                          $last_limit2 = $check_day_day->row_num;
                          //echo $row->empid." - ".$out_count2." 3<br>";
                        }
                      }
                  ...
                  if ($day_hour >= '08:00:00' && $day_hour != strtotime("00:00:00")){  
                    ...
                    //} else {
                      if ($out_count == 1){
                        ...
                        //echo $row->empid." - ".$out_count2."<br>";
                        if ($out_count2 == 1){
                          if ($check_day_day->rows <= 2){
                        ...
                        } else if ($out_count2 == 0){
                          if ($check_day_day->rows == 1){
                            $start = $check_day_day->rows;
                            $last = 2;
                          } else {
                            $start = $check_day_day->rows - 1;
                        ...
                        } else if ($out_count2 > 1){
                          $start = $last_limit2 - 2; //check error 1
                          $last = 2; //addeddddd
                          //echo $row->empid." - ".$check_day_day->timestamp." 2<br>";
                          //echo $row->empid." - ".$start." two<br>";
                        }
